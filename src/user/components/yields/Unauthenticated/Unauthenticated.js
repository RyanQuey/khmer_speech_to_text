          ...
          <Flexbox direction="column">
            ...
            <Flexbox className={classes.mainContainer}>
              <div className={classes.content}>
                ...
                <p>
                  In order to sign up, contact us at <a href={`mailto:${supportEmail}`} target="_blank">{supportEmail}</a>.
                </p>
                <div className={classes.broughtToYouBy}>
                  <a href="https://sbbic.org/" target="_blank">Brought to you by: The Society for Better Books in Cambodia</a>
                </div>
              </div>
            </Flexbox>
          </Flexbox>
